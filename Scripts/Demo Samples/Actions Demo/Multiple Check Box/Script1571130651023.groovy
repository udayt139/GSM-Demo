...
WebUI.click(findTestObject('Demo Samples/Actions Demo/Multiple Check Box/Page_GSM Portal/button_Log in'))
...
WebUI.click(findTestObject('Demo Samples/Actions Demo/Multiple Check Box/Page_Dashboard/div_Content'))
